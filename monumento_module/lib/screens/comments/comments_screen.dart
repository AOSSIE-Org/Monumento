...
class _CommentsScreenState extends State<CommentsScreen> {
  ...
  void initState() {
    ...
    _authenticationBloc = BlocProvider.of<AuthenticationBloc>(context,listen: false);
    _commentsBloc
                  ...
                  children: [
                    ClipOval(
                      child: CachedNetworkImage(
                        imageUrl:
                            _authenticationBloc.state is Authenticated ? (_authenticationBloc.state as Authenticated).user.profilePictureUrl : "" ,
                        height: 36,
                      ),
                    ),
                    SizedBox(
