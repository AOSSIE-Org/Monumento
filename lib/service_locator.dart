...
import 'data/repositories/appwrite_authentication_repository.dart';
import 'data/repositories/appwrite_monument_repository.dart';
import 'data/repositories/appwrite_social_repository.dart';
...
void setupAppRepos() {
  ...
  locator.registerLazySingleton<SocialRepository>(() => AppwriteSocialRepository(
            authenticationRepository: locator<AuthenticationRepository>(),
            database: locator<Databases>(),
