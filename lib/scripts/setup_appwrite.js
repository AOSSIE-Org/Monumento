...
async function createCollections(databases, databaseId) {
  try {
    ...
    const communitiesCollection = await createCommunitiesCollection(databases, databaseId); // ✅ Add this line
    ...
    await setupCommunitiesAttributes(databases, databaseId, communitiesCollection.$id); // ✅ Add this line
...
// Add this function after your existing collection creation functions
...
async function setupCommunitiesAttributes(databases, databaseId, collectionId) {
  ...
  // Create relationship with users collection
  await databases.createRelationshipAttribute(
    databaseId,
    collectionId,
    'users',
