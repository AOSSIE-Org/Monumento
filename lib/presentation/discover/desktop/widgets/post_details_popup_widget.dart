...
class _PostDetailsPopupWidgetState extends State<PostDetailsPopupWidget> {
  ...
  void initState() {
    ...
    locator<CommentsBloc>().add(LoadInitialComments(postDocId: widget.post.postId));
    super.initState();
  }
                  ...
                  children: [
                    ...
                    CircleAvatar(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: widget.post.author.profilePictureUrl ?? defaultProfilePicture,
                  ...
                  child: BlocBuilder<CommentsBloc, CommentsState>(
                    ...
                    buildWhen: (previous, current) {
                      if (current is InitialCommentsLoaded) {
                        ...
                        if (shouldRebuild) {
                          comments = current.initialComments.map((e) => e.toEntity()).toList();
                        }
                    ...
                    child: LikeButton(
                      ...
                      likeBuilder: (isLiked) {
                        return SvgPicture.asset(
                          isLiked ? 'assets/icons/ic_heart_filled.svg' : 'assets/icons/ic_heart.svg',
                          width: 24,
                          height: 24,
                        );
                      },
