...
class ResetPasswordViewMobile extends StatefulWidget {
  const ResetPasswordViewMobile({super.key});

  @override
  State<ResetPasswordViewMobile> createState() =>
      _ResetPasswordViewMobileState();
}

class _ResetPasswordViewMobileState extends State<ResetPasswordViewMobile> {
